...
const privacyContent = [
  ...
  {
    heading: "This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.",
    type: "sub"
  },
  {
    heading: "We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the Privacy Policy Generator.",
    type: "sub"
  },
  {
  ...
  },
  {
    ...
    By email: support@omniebeeglobalsolutions.com
    By visiting this page on our website: https://omniebeeglobalsolutions.com/`
  }
];
...
const Page = () => {
  return (
    <div className="max-w-6xl mx-auto px-4 py-12 text-gray-800">
      ...
      {privacyContent.slice(3).map((section, idx) => (
        <div key={idx} className="mb-8">
          <h2 className="text-xl md:text-2xl font-semibold text-[#2E3E95] mb-2 font-poppins justify-center text-justify">
            {section.heading}
          </h2>
          {section.text && section.text.split(/\n+/).map((para, i) => (
            <p key={i} className="mb-2 text-base leading-relaxed text-gray-700 font-inter justify-center text-justify">
              {para}
            </p>
          ))}
        </div>
