...
const MoveToTopButton = () => {
  ...
  return (
    <button
      ...
      className={`fixed z-50 bottom-6 right-6 bg-[#56B9F0]  text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg transition-all duration-300 ${
        visible
