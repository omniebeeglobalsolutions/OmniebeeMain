...
export default async function LeadershipSection() {
  ...
  return (
    <section className="py-12 bg-white text-center">
      <h2 className="text-[32px] sm:text-[40px] font-bold text-[#2E3E95] mb-2 font-poppins">
        Leadership
      </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-4 sm:px-6 max-w-3xl mx-auto">
        {members?.map((member, index) => {
          const imageSrc =
            member.image?.secure_url || "/profile.jpg"; // Fallback image
          ...
          return (
            ...
            >
              ...
              <p className="text-[#479BC9] text-[14px] sm:text-[15px] md:text-[17.5px]">
