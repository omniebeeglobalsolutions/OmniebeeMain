  ...
  return (
    <section className="relative bg-white py-10 px-4 lg:px-32 text-center overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-0 relative min-h-[500px]">
        ...
        <h2 className="text-[28px] sm:text-[32px] md:text-[38px] lg:text-[45px] font-bold text-[#2E3E95] mb-1">
          Our Story
        </h2>
        ...
        <div className="max-w-[1000px] mx-auto">
          <p className="font-inter text-[16px] font-normal text-black mb-6">
          ...
          <p className="font-inter text-[16px] font-normal text-black text-center">
