...
const termsContent = [
  {
    ...
    date: "Last updated: July 15, 2025",
    type: "main"
  },
  {
    heading: "Please read these terms and conditions carefully before using Our Service.",
    type: "sub"
  },
  {
  ...
  },
  {
    ...
    \nCompany (referred to as either \"the Company\", \"We\", \"Us\" or \"Our\" in this Agreement) refers to Omniebee Global Solutions, Office No: 301, 3rd Floor, Manjeera Majestic Commercial, Kukatpally, Hyderabad - 500085.
    \nDevice means any device that can access the Service such as a computer, a cellphone or a digital tablet.
    \nService refers to the Website.
    \nTerms and Conditions (also referred as \"Terms\") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement has been created with the help of the Terms and Conditions Generator.
    \nThird-party Social Media Service means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.
    \nWebsite refers to Omniebee Global Solutions, accessible from https://omniebeeglobalsolutions.com/
    ...
    <div className="max-w-6xl mx-auto px-4 py-12 text-gray-800">
      <div className="w-full mb-10 relative h-48 md:h-64 flex items-center justify-center">
        ...
        <div className="absolute inset-0 bg-[#2E3E95] bg-opacity-60 rounded-lg flex flex-col items-center justify-center">
          ...
          <p className="text-center text-sm md:text-base text-gray-100 font-medium">
            Last updated: July 15, 2025
          </p>
        </div>
      </div>
      {termsContent.slice(2).map((section, idx) => (
        <div key={idx} className="mb-8">
          <h2 className="text-xl md:text-2xl font-semibold text-[#2E3E95] mb-2 font-poppins">
            {section.heading}
          </h2>
          {section.text && section.text.split(/\n+/).map((para, i) => (
            <p key={i} className="mb-2 text-base leading-relaxed text-gray-700 font-inter">
              {para}
            </p>
          ))}
        </div>
